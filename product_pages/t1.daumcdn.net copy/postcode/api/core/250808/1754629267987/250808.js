(function() { /*VERSION:250808*/
    ...
    var postcodeConf = {
            logUrl: "https://stlog1-local.kakao.com",
            guideURL: "https://postcode.map.daum.net/guide",
            localURL: "http://localhost:8080",
            devURL: "https://postcode.dev.daum.net",
            cbtURL: "https://cbt-postcode.dev.daum.net",
            prodURL: "https://postcode.map.daum.net",
            noticeURL: ""
        },
        postcodeUtils = {};
    postcodeUtils.param = function(a) {
        ...
        function d(a) {
            var b = {},
                c = !!/android/.test(a) && "android" || !!/like mac os x./.test(a) && "ios" || !!/(mac os)/.test(a) && "mac" || !!/polaris|natebrowser|([010|011|016|017|018|019]{3}\d{3,4}\d{4}$)/.test(a) && "polaris" || !!/(windows)/.test(a) && "windows" || !!/(linux)/.test(a) && "linux" || !!/webos/.test(a) && "webos" || !!/bada/.test(a) && "bada" || !!/(rim|blackberry)/.test(a) && "blackberry" || "unknown";
        ...
        for (var b = ["version/", "samsungbrowser", "daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; d < e; d++)
            if (a.indexOf(b[d]) > -1) {
                c = !0;
                break
            }
        ...
        for (var b = ["version/7", "version/8", "version/9", "version/10", "version/11", "version/12", "version/13", "version/14", "version/15"], c = 0, d = 0, e = b.length; d < e; d++) a.indexOf(b[d]) === -1 && c++;
        ...
        return null
    }, postcodeUtils.clamp = function(a, b, c) {
    ...
    ! function(a, b, c, d, e) {
        ...
        a.CONT = {
            ...
            function n(a, b) {
                if (q.POPUP_MAP[a])
                    for (var c = q.POPUP_MAP[a], d = 0, e = c.length; d < e; d++)
            ...
            function o(a) {
                for (var b in q.POPUP_MAP)
                    if (q.POPUP_MAP.hasOwnProperty(b))
                        for (var c = q.POPUP_MAP[b], d = 0, e = c.length; d < e; d++)
        ...
        }(), a.dataUtils = function() {
            function a(a) {
                var b = [a ? a.roadnameEnglish : ""];
                if (a && "J" === a.addressType) {
                    for (var c = a.roadAddressEnglish || a.autoRoadAddressEnglish || "", d = c.replace(/^[^\s]+\s*/, ""), e = d.split(","), f = 0; f < e.length; f++) e[f] = e[f].replace(/^\s+|\s+$/g, "");
                    b = e
                }
                return b[0]
            }
            return {
                adjustRoadnameEnglish: a
            }
        }()
    ...
    ! function(a, b, c, d, e) {
        ...
        a.frame = function() {
            ...
            function b(a) {
                ...
                return f.userAgent.os.ios && f.isIOSWebview(f.userAgent.ua_string) && (c = {
                    width: "100%",
                    height: "100%",
                    border: "0 none",
                    margin: "0",
                    ...
                    overflow: "hidden",
                    "min-width": a.minWidth + "px"
                }), b.setAttribute("frameborder", "0"), b.setAttribute("title", "우편번호서비스 레이어 프레임"), b.style.cssText = f.getStringByOptions(c, ":", ";"), b
            }
            ...
            function e(c, d) {
                ...
                var e = a(c),
                    g = b(c);
                return e.id = j.setId("layer", c.viewerNo), g.src = "about:blank", e.appendChild(g), h.append(d, e), f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string) ? setTimeout(function() {
                    l(g, e, c, d)
            ...
            function l(a, b, c, d) {
                ...
                e.document.write(t(c)), h.setFrameStyle(e.document.getElementsByTagName("html")[0], e.document.getElementsByTagName("body")[0]), e.document.close(), j.setReady(e, function(f, i) {
                    if ("reload" === f) {
                        if (a.focus(), e && e.document) {
                            var l = e.document.getElementById(j.getId("viewerFrame", c.viewerNo));
                            l && l.focus()
                        }
                    } else "search" === f ? c.onSearch !== g.EMPTY_FUNCTION && c.onSearch(i) : "resize" === f ? c.onResize !== g.EMPTY_FUNCTION && (c.onResize(i), h.adjustLowIE(e, a, b, j.getId("viewerFrame", c.viewerNo), i.width, i.height)) : "done" === f && c.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() {
                        try {
                            i.roadnameEnglish = k.adjustRoadnameEnglish(i)
                        } catch (a) {}
                        c.onComplete(i), c.autoClose && (h.IE11CompatibleBugFix(e), h.remove(d, b), c.onClose !== g.EMPTY_FUNCTION && c.onClose(g.POPUP_CLOSE_STATE.COMPLETE))
                    }, 0)
                }, c)
            }
            ...
            function m(a) {
                ...
                if (a.popupKey && o(e), f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string)) {
            ...
            function n(a, b) {
                var c = a.window;
                c.document.write(t(b)), h.setFrameStyle(c.document.getElementsByTagName("html")[0], c.document.getElementsByTagName("body")[0]), c.document.close();
                try {
                    ...
                    if (d) {
                        var e = b.popupTitle || "Daum Postcode Service",
                            f = null,
                            i = null,
                            l = c.document.getElementsByTagName("title")[0];
                        l ? (d.removeChild(l), f = c.document.createElement("title"), f.innerHTML = e, d.appendChild(f)) : (f = c.document.createElement("title"), f.innerHTML = e, i = c.document.createElement("meta"), i.name = "viewport", i.content = "user-scalable=no,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,width=device-width", d.appendChild(f), d.appendChild(i))
                    }
                } catch (m) {}
                j.setReady(c, function(c, d) {
                    "done" === c ? b.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() {
                        try {
                            d.roadnameEnglish = k.adjustRoadnameEnglish(d)
                        } catch (c) {}
                        if (b.onComplete(d), b.autoClose)
                            if (b.onClose !== g.EMPTY_FUNCTION) {
                                var e = h.getPopupMap(a);
                                e && clearInterval(e.data.closeCallbackTimer), a.close(), b.onClose(g.POPUP_CLOSE_STATE.COMPLETE)
                            } else a.close()
                    }, 0) : "search" === c && b.onSearch !== g.EMPTY_FUNCTION && b.onSearch(d)
                }, b)
            }
            ...
            function p(a, b) {
                if (b.onClose !== g.EMPTY_FUNCTION) {
                    ...
                    c && (clearInterval(c.data.closeCallbackTimer), c.data.closeCallbackTimer = setInterval(function() {
                        var d = a.closed === !0;
                        d || void 0 !== a.closed || (d = void 0 === a.window || null === a.window), d && (clearInterval(c.data.closeCallbackTimer), b.onClose(g.POPUP_CLOSE_STATE.FORCE))
                    }, 250))
                }
            }
            var q = null,
                ...
                t = function(a) {
                    var b = {
                        ...
                        c = {
                            inc: a.noticeURL ? encodeURIComponent(f.trim(a.noticeURL)) : "",
                    ...
                    var d = q + "&" + f.getStringByOptions(c, "=", "&"),
                        ...
                        i = '<iframe frameborder="0" title="우편번호 검색 프레임" id="' + j.setId("viewerFrame", a.viewerNo) + '" src="' + h.getValidationUrl(d, e, g) + '" style="' + f.getStringByOptions(b, ":", ";") + '"></iframe>';
                    return i
                };
            return {
                init: function(a, b, c) {
    ...
    ! function(a, b, c, d, e, f) {
        function g(a, b) {
            for (var c = 0; c < b; ++c) alert(a), console && "function" == typeof console.error && console.error(a)
        }
        ...
        function h(a, b) {
            ...
            if (b) {
                var d = b.q,
                    e = !0;
                d && "string" == typeof d && "" !== p.trim(d) && (c = e === !0 ? p.extend(a, {
        ...
        function j(a, b) {
            ...
            if (b) {
                ...
                d && "string" == typeof d && "" !== p.trim(d) && (c = p.extend(a, {
                    popupKey: d
                }))
            }
            return c
        ...
        function k(a, b) {
            ...
            if (b) {
                var d = b.autoClose;
                void 0 !== d && null !== d && "boolean" == typeof d && (c = p.extend(a, {
                    autoClose: d
                }))
            }
            return c
        ...
        function m(a) {
            var b = ++s.VIEWER_COUNT,
                c = {
                    minWidth: r.MIN_WIDTH,
                    width: r.DEFAULT_WIDTH,
                    height: r.DEFAULT_HEIGHT,
                    top: 50,
                    left: 100,
                    onComplete: r.EMPTY_FUNCTION,
                    oncomplete: r.EMPTY_FUNCTION,
                    onResize: r.EMPTY_FUNCTION,
                    onresize: r.EMPTY_FUNCTION,
                    onClose: r.EMPTY_FUNCTION,
                    onclose: r.EMPTY_FUNCTION,
                    onSearch: r.EMPTY_FUNCTION,
                    onsearch: r.EMPTY_FUNCTION,
                    autoMapping: !0,
                    autoMappingJibun: !0,
                    autoMappingRoad: !0,
            ...
            p.extend(c, a, {
                ...
                autoHiddenSuggest: !1,
                zonecodeOnly: !0,
                noticeURL: q.noticeURL
            }), "string" == typeof c.minWidth ? isNaN(c.minWidth) ? c.minWidth = r.MIN_WIDTH : c.minWidth = p.clamp(parseInt(c.minWidth, 10), 0, r.MIN_WIDTH) : "number" == typeof c.minWidth ? c.minWidth = p.clamp(c.minWidth, 0, r.MIN_WIDTH) : c.minWidth = r.MIN_WIDTH;
            var d = t.getNormalizeSize(c.width, r.DEFAULT_WIDTH, c.minWidth),
                e = t.getNormalizeSize(c.height, r.DEFAULT_HEIGHT, r.MIN_HEIGHT);
            if (c.width = d.value, c.isFlexibleWidth = d.isFlexible, c.height = e.value, c.isFlexibleHeight = e.isFlexible, c.onComplete && "function" == typeof c.onComplete && c.onComplete !== r.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== r.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = r.EMPTY_FUNCTION, c.oncomplete = r.EMPTY_FUNCTION, c.isViewerMode = !0), c.onResize && "function" == typeof c.onResize && c.onResize !== r.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== r.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = r.EMPTY_FUNCTION, c.onresize = r.EMPTY_FUNCTION), c.onClose && "function" == typeof c.onClose && c.onClose !== r.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== r.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = r.EMPTY_FUNCTION, c.onclose = r.EMPTY_FUNCTION), c.onSearch && "function" == typeof c.onSearch && c.onSearch !== r.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== r.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = r.EMPTY_FUNCTION, c.onsearch = r.EMPTY_FUNCTION), "boolean" != typeof c.autoMappingJibun && (c.autoMappingJibun = !0), "boolean" != typeof c.autoMappingRoad && (c.autoMappingRoad = !0), "boolean" != typeof c.autoMapping && (c.autoMapping = !0), "boolean" == typeof a.autoMapping && (c.autoMappingJibun = c.autoMappingRoad = c.autoMapping), "boolean" != typeof c.animation && (c.animation = !1), "boolean" != typeof c.shorthand && (c.shorthand = !0), "boolean" != typeof c.focusInput && (c.focusInput = !0), "boolean" != typeof c.focusContent && (c.focusContent = !0), "boolean" != typeof c.hideMapBtn && (c.hideMapBtn = !1), "boolean" != typeof c.hideEngBtn && (c.hideEngBtn = !1), "boolean" != typeof c.showMoreHName && (c.showMoreHName = !1), "boolean" != typeof c.alwaysShowEngAddr ? c.alwaysShowEngAddr = !1 : c.alwaysShowEngAddr && (c.hideEngBtn = !0), "boolean" != typeof c.submitMode && (c.submitMode = !0), "boolean" != typeof c.useSuggest && (c.useSuggest = !0), "boolean" != typeof c.autoHiddenSuggest && (c.autoHiddenSuggest = !1), isNaN(c.pleaseReadGuide) || "number" != typeof c.pleaseReadGuide ? c.pleaseReadGuide = 0 : (c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10), c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0), c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)), isNaN(c.pleaseReadGuideTimer) || "number" != typeof c.pleaseReadGuideTimer ? c.pleaseReadGuideTimer = 1.5 : (c.pleaseReadGuideTimer = parseFloat(c.pleaseReadGuideTimer), c.pleaseReadGuideTimer <= 0 && (c.pleaseReadGuideTimer = 1.5), c.pleaseReadGuideTimer > 60 && (c.pleaseReadGuideTimer = 1.5)), isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems ? c.maxSuggestItems = 10 : (c.maxSuggestItems = parseInt(c.maxSuggestItems, 10), (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) && (c.maxSuggestItems = 10)), c.windowHeightAvailableForSuggest = 45 * c.maxSuggestItems + 50, c.theme) {
                var f = v.getPreprocessResult(c.theme);
                null === f ? c.theme = null : c.theme = f
            }
            "boolean" != typeof c.allAddr && (c.allAddr = !1), "boolean" != typeof c.zonecodeOnly && (c.zonecodeOnly = !1), "boolean" != typeof c.useBannerLink && (c.useBannerLink = !0), this._opt_ = c
        }
        var n = d.daum.postcode;
        if (!n) return void alert("[우편번호 서비스] API 로딩 오류가 발생하였습니다. 확인 바랍니다. 지속적인 오류 발생시 ( https://github.com/daumPostcode/QnA/issues ) 이슈 등록 부탁드립니다.");
        var o = function(a) {
            var b = a._validParam_,
                c = -1;
            return function(a, d) {
                return !b && (g(d, 3), a && (c = setInterval(function() {
                    g(d, 3);
                }, 6e5)), !0)
            }
        }(n);
        o(!0, "[우편번호 서비스 로딩 오류] API 로딩시 허용되지 않는 파라미터가 감지되었습니다. 사이트 관리자(개발자)분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.");
        var p = b,
            q = c,
            r = a.CONT,
            s = a.MODEL,
            t = a.viewUtils,
            u = a.frame,
            v = a.themePreprocessor,
            w = "http:" !== a.CONT.PROTOCOL,
            x = (w ? "https:" : "http:") + "//postcode.map.daum.net/search",
            y = encodeURIComponent(r.PROTOCOL + "//" + f.host),
            z = encodeURIComponent(f.pathname),
            A = "",
            B = x + "?origin=" + y;
        u.init(B, z, A), m.prototype = {
            open: function(a) {
                if (!o(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    var b = p.extend({}, this._opt_);
                    b = h(b, a), b = i(b, a), b = j(b, a), b = k(b, a), b = l(b, a), b = p.extend(b, {
                        viewType: "popup"
                    }), u.popup.create(b)
                }
            },
            embed: function(a, b) {
                if (!o(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    var c = p.extend({}, this._opt_);
                    c = h(c, b), c = k(c, b), c = p.extend(c, {
                        viewType: "layer"
                    }), u.layer.create(c, a)
                }
            }
        }, d.daum.Postcode = m
    }(v2, postcodeUtils, postcodeConf, window, document, location);
})();