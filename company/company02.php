...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="box">
			...
			<!--상단 유틸리티 시작-->
			<ul class="unb_top">
				<li><a href="/member/login.html" target="_self"><a href='/member/login.html?prev=/company/company02.html'>로그인</a></a></li>
				<li>ㅣ</li>
			...
			<div class="snb">
			  ...
			  <div class="leftArea">
				<ul>
				  ...
				  <li id="on"><a href="company02.html">조직도</a></li>
		...
		<div class="box">
			...
			<div class="subcontents">
				...
				<div class="box_title">
					...
					<div class="title">
						<span class="blue">COMPANY</span><br />조직도
					</div>

					<div class="path">
						HOME > 회사소개 > <strong>조직도</strong>
					</div>
				...
				<!--내용 시작-->		
				<div class="text_sub">
				  <img src="/company/images/조직도.jpg">
				</div>
				<!--내용 끝-->
