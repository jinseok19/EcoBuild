...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="box">
			...
			<!--상단 유틸리티 시작-->
			<ul class="unb_top">
				<li><a href="/member/login.html" target="_self"><a href='/member/login.html?prev=/company/company01.html'>로그인</a></a></li>
				<li>ㅣ</li>
  ...
  <tr>
	...
	<!--상단 끝-->		
			...
			<div class="snb">
			  ...
			  <div class="leftArea">
				<ul>
				  <li id="on"><a href="company01.html">인사말</a></li>
		...
		<div class="box">
			...
			<div class="subcontents">
				...
				<div class="box_title">
					...
					<div class="title">
						<span class="blue">COMPANY</span><br />인사말
					</div>
				...
				<div class="text_sub">
					...
					<img src="/company/images/인사말.jpg" alt=""  />
