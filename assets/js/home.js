jQuery(function($) {
    ...
    gsap.timeline({
        ...
        .from('#homeTop .__featured-slide .__animated > *', {
            y: '105%',
            autoAlpha: 0,
            duration: 1.125,
            ease: Quart.easeOut,
        ...
        .from('#homeTop .__featured-slide .__controls', {
            y: '105%',
            autoAlpha: 0,
            duration: 1.125,
            ease: Quart.easeOut,
        ...
        .from('#homeTop .__news-slide .__animated > *', {
            y: '105%',
            duration: 1.125,
            ease: Quart.easeOut,
            stagger: 0.08,
        ...
        .from('#homeTop .__stock-info .__animated > *', {
            y: '105%',
            duration: 1.125,
            ease: Quart.easeOut,
            stagger: .2
    ...
    gsap.timeline({
        ...
        .from('#homeNewsroom .__category-filter .__filter-item', {
            x: '2rem',
            autoAlpha: 0,
            duration: 1.125,
            ease: Quart.easeOut,
        ...
        .from('#homeNewsroom .__newsroom-post-item', {
            x: '30%',
            autoAlpha: 0,
            duration: 1.125,
            ease: Quart.easeOut,
