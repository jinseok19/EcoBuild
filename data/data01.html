...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="box">
			...
			<!--상단 유틸리티 시작-->
			<ul class="unb_top">
				<li><a href="/member/login.html" target="_self"><a href='/member/login.html?prev=/data/data01.html'>로그인</a></a></li>
				<li>ㅣ</li>
  ...
  <tr>
	...
	<!--상단 끝-->		
			...
			<div class="snb">
			  ...
			  <div class="leftArea">
				<ul>
				  <li id="on"><a href="data01.html">설명서</a></li>
				  <li ><a href="data02.html">MSDS</a></li>
		...
		<div class="box">
			...
			<div class="subcontents">
				...
				<div class="box_title">
					...
					<div class="title">
						<span class="blue">DATA</span><br />설명서
					</div>

					<div class="path">
						HOME > 자료실 > <strong>설명서</strong>
					</div>
  ...
  <tr>
    <td colspan="10" height="1" bgcolor="#d7d7d7"></td>
	  ...
	  <td align="center" height="28">13</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5182&page=1&code=data'>GK-수처리종균제</a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5182&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">12</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5165&page=1&code=data'>GK-자동분사장치 대</a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5165&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">11</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5164&page=1&code=data'>GK-자동공급장치 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5164&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">10</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5163&page=1&code=data'>GK-자동분사장치 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5163&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">9</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5162&page=1&code=data'>GK-분말종균제 설명서 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5162&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">8</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5161&page=1&code=data'>B-LIVE BF 탈취제 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5161&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">7</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5160&page=1&code=data'>B-LIVE BR1 설명서 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> <a href='/admin/bbs/down.html?code=data&idx=5160&no=1'><img src='/admin/bbs/skin/bbsBasic/image/file.gif' border='0' align='absmiddle'></a></td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">6</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5143&page=1&code=data'>GK-뇨석제거제  설명서 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">5</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5139&page=1&code=data'>GK-석회제거제 설명서</a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	  <td align="center">관리자</td>
	  <td align="center">2015-05-28</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">4</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5138&page=1&code=data'>GK-오물용해제 설명서 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">3</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5137&page=1&code=data'>GK-유분용해제 설명서</a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">2</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5136&page=1&code=data'>GK-유지방분해제 설명서</a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
	...
	<tr>
	  ...
	  <td align="center" height="28">1</td>
	    ...
	    <tr>
	    	<td style="padding-left:3px"> <a href='/data/data01.html?ptype=view&idx=5135&page=1&code=data'>GK-쿨링타워 살균제 </a>    <img src='/admin/bbs/skin/bbsBasic/image/hot.gif' border='0' align='absmiddle'> </td>
	    </tr>
	    <tr><td height="1"></td></tr>
	    </table>
		</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" align="center">
			    <table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center'>      <table border='0' cellspacing='0' cellpadding='0'>        <tr>          <td width='22' height='50'><a href='?ptype=&page=1&code=data'><img src='/admin/bbs/skin/bbsBasic/image/btn_prev2.gif' align='absmiddle' border=0'></a></td>          <td width='22'><a href='?ptype=&page=1&code=data'><img src='/admin/bbs/skin/bbsBasic/image/btn_prev.gif' align='absmiddle' border=0'></a></td>          <td align='center'>&nbsp; <b>1</b> /           &nbsp; </td>          <td width='22' align='right'><a href='?ptype=&page=1&code=data'><img src='/admin/bbs/skin/bbsBasic/image/btn_next.gif' align='absmiddle' border='0'></a></td>          <td width='22' align='right'><a href='?ptype=&page=1&code=data'><img src='/admin/bbs/skin/bbsBasic/image/btn_next2.gif' align='absmiddle' border='0'></a></td>        </tr>      </table>    </td></tr></table>    </td>
  </tr>
</table>  
<!-- 페이지 번호끝 -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" align="center" bgcolor="#f9f9f9" style="border-top:1px solid #a9a9a9; border-bottom:1px solid #d7d7d7; padding:5px 0px;">
        ...
        <form name="sfrm" action="/data/data01.html">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="right" style="padding-top:10px"><a href='/data/data01.html?ptype=list&code=data'><img src='/admin/bbs/skin/bbsBasic/image/btn_list.gif' border='0'></a>&nbsp;</td>
  </tr>
</table>  
<!-- 버튼 끝 -->				</div>
				<!--내용 끝-->
