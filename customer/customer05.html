...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="box">
			...
			<!--상단 유틸리티 시작-->
			<ul class="unb_top">
				<li><a href="/member/login.html" target="_self"><a href='/member/login.html?prev=/customer/customer05.html'>로그인</a></a></li>
				<li>ㅣ</li>
			...
			<div class="snb">
			  ...
			  <div class="leftArea">
				<ul>
				  ...
				  <li id="on"><a href="customer05.html">구매후기</a></li>
		...
		<div class="box">
			...
			<div class="subcontents">
				...
				<div class="box_title">
					...
					<div class="title">
						<span class="blue">CUSTOMER</span><br />구매후기
					</div>

					<div class="path">
						HOME > 고객센터 > <strong>구매후기</strong>
					</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" align="center" bgcolor="#f9f9f9" style="border-top:1px solid #a9a9a9; border-bottom:1px solid #d7d7d7; padding:5px 0px;">
        ...
        <form name="sfrm" action="/customer/customer05.html">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="right" style="padding-top:10px"><a href='/customer/customer05.html?ptype=list&code=review'><img src='/admin/bbs/skin/bbsBasic/image/btn_list.gif' border='0'></a>&nbsp;</td>
  </tr>
</table>  
<!-- 버튼 끝 -->				</div>
				<!--내용 끝-->
