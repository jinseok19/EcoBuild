...
<div id="wrap">
	...
	<div id="header">
		...
		<div class="box">
			...
			<!--상단 유틸리티 시작-->
			<ul class="unb_top">
				<li><a href="/member/login.html" target="_self"><a href='/member/login.html?prev=/equipment/equipment01.html'>로그인</a></a></li>
				<li>ㅣ</li>
  ...
  <tr>
	...
	<!--상단 끝-->		
			...
			<div class="snb">
			  ...
			  <div class="leftArea">
				<ul>
				  <li id="on"><a href="equipment01.html">GK-자동투입장치</a></li>
		...
		<div class="box">
			...
			<div class="subcontents">
				...
				<div class="box_title">
					...
					<div class="title">
						<span class="blue">EQUIPMENT</span><br />GK-자동투입장치
					</div>

					<div class="path">
						HOME > 기계장치 > <strong>GK-자동투입장치</strong>
					</div>
...
<div style="text-align: left"><img style="width: 640px; height: 805px" alt="상세 공급장치new-1.jpg" src="http://greenkorea.1004hp.com/admin/data/webedit/20160304175106_nrublhug.jpg" /></div><br />
<div style="text-align: left"><img style="width: 640px; height: 829px" alt="상세 공급장치new-2.jpg" src="http://greenkorea.1004hp.com/admin/data/webedit/20160304175111_mfnavomx.jpg" /></div><br />
<div style="text-align: left"><img style="width: 640px; height: 1174px" alt="상세 공급장치new-3.jpg" src="http://greenkorea.1004hp.com/admin/data/webedit/20160304175115_fxsanroy.jpg" /></div><br />
<div style="text-align: left"><img style="width: 640px; height: 480px" alt="분사설명서-4 - 복사본.jpg" src="http://greenkorea.1004hp.com/admin/data/webedit/20160304175120_vioabdfp.jpg" /></div><br /> -->
	...
	<tr>
		<td align="center" style="padding:5px 0px;">
		    ...
		    <tr>
		      ...
		      <td width="99%" align="left" style="background:url('/admin/product//image/product_title_bg.gif') top left repeat-x; font-size:14px; color:#ffffff; font-family:Dotum; font-weight:bold; padding-left:12px;">GK-자동투입장치</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<form action="/equipment/equipment01.html" method="get">
					<input type="hidden" name="catcode" value="231000">
	  	...
	  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  		<tr><td height="10"></td></tr>
				...
				<tr><td align="center" class="prd"><a href="/equipment/equipment01.html?ptype=view&prdcode=1703240001&catcode=231000&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey="><img src="/admin/data/prdimg/1703240001_R.jpg" border="0" width="130" height="130"></a></td></tr>
				<tr><td align="center"><a href="/equipment/equipment01.html?ptype=view&prdcode=1703240001&catcode=231000&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey="><a href='/equipment/equipment01.html?ptype=view&prdcode=1703240001&catcode=231000&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey='>GK-액체자동공급장치</a></a></td></tr>
				<tr><td align="center"><font class=price>관리자 문의</font></td></tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td height="10">    <table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center'>      <table border='0' cellspacing='0' cellpadding='0'>        <tr>          <td width='22' height='50'><a href='?ptype=&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey='><img src='/admin/product//image/btn_prev2.gif' align='absmiddle' border=0'></a></td>          <td width='22'><a href='?ptype=&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey='><img src='/admin/product//image/btn_prev.gif' align='absmiddle' border=0'></a></td>          <td align='center'>&nbsp; <b>1</b> /           &nbsp; </td>          <td width='22' align='right'><a href='?ptype=&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey='><img src='/admin/product//image/btn_next.gif' align='absmiddle' border='0'></a></td>          <td width='22' align='right'><a href='?ptype=&page=1&catcode=231000&grp=&brand=&orderby=&searchopt=&searchkey='><img src='/admin/product//image/btn_next2.gif' align='absmiddle' border='0'></a></td>        </tr>      </table>    </td></tr></table></td>
				</tr>
			</table>
